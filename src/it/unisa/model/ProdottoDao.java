...
public class ProdottoDao implements ProdottoDaoInterfaccia{
	...
	public synchronized ArrayList<ProdottoBean> doRetrieveAll(String order) throws SQLException {
	    ...
	    // Definisci una whitelist di colonne consentite per l'ordinamento
	    List<String> allowedColumns = Arrays.asList("NOME", "PIATTAFORMA", "DESCRIZIONE", "PREZZO", "QUANTITA", "GENERE", "DATA_USCITA", "IN_VENDITA", "IVA", "IMMAGINE", "DESCRIZIONE_DETTAGLIATA");

	    // Costruisci la query di base
	    String selectSQL = "SELECT * FROM " + ProdottoDao.TABLE_NAME;

	    // Verifica se il parametro 'order' è nella whitelist
	    if (order != null && !order.isEmpty() && allowedColumns.contains(order.toUpperCase())) {
